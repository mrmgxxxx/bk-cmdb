...
const (
	...
	// e.g: cc:v3:event:ownerid:type:suber:cursor_1:hostcreate:1 -> MarshalChainNodeStr
	EventCacheSubscriberCursorPrefix = common.BKCacheKeyV3Prefix + "event:ownerid:type:suber:cursor_"
)
